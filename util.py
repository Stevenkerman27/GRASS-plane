...
def get_args():
    ...
    # GAN Hyperparameters
    parser.add_argument('--alpha1', type=float, default=0.001, help='Weight for VAE reconstruction loss in GAN training')
    ...
    parser.add_argument('--gan_beta1', type=float, default=0.5, help='Beta1 for GAN Adam optimizer')
