...
FUSELAGE_GLOBAL_SIZE = 6
FUSELAGE_SECTION_SIZE = 6
...
# Fixed-leading-edge CST: two shape coefficient vectors, one centered
# trailing-edge thickness, and two independently fitted class-function exponents.
CST_MIN_CLASS_FUNCTION_EXPONENT = 0.05
CST_SURFACE_SHAPE_COEFFICIENTS = 8
CST_BOUNDARY_CODE_SIZE = 3
CST_AIRFOIL_CODE_SIZE = 2 * CST_SURFACE_SHAPE_COEFFICIENTS + CST_BOUNDARY_CODE_SIZE
WING_GLOBAL_SIZE = 5
WING_SECTION_GEOMETRY_SIZE = 5
WING_SECTION_SIZE = WING_SECTION_GEOMETRY_SIZE + CST_AIRFOIL_CODE_SIZE
CST_FIT_CONFIG = {
    'iterations': 700,
    'lr': 0.005,
    'loss_scale': 100.0,
...
WING_SECTION_COUNT = 6
FUSELAGE_SECTION_COUNT = 10
SECTION_CODEC_CONV_CHANNELS = 64
SECTION_CODEC_HIDDEN_SIZE = 200
AE_CHECKPOINT_EVERY = 20
SECTION_AE_OVERFIT_AIRCRAFT_COUNT = 2
SECTION_AE_WING_FINAL_EPOCH = 200
SECTION_AE_FUSELAGE_FINAL_EPOCH = 150
...
def get_args():
    ...
    parser.add_argument('--save_log_every', type=int, default=10)
    ...
    parser.add_argument('--ae_log_every', type=int, default=10)
